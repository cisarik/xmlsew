...
/**
 * This is the model class for table "xmlsew_elementrequiredattributes".
 *
 * The followings are the available columns in table 'xmlsew_elementrequiredattributes':
 * @property string $id
 ...
 */
class Elementrequiredattributes extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Elementrequiredattributes the static model class
	 */
	...
	{
		return 'xmlsew_elementrequiredattributes';
	}
